...
AnimSpriteComponent::AnimSpriteComponent(Actor *ownerP,
                                         const std::vector<Texture *> &textureP,
                                         int drawOrderP)
    : SpriteComponent(ownerP, *textureP[0], drawOrderP), currentFrame(0.0f),
      animFPS(24.0f) {
...
void AnimSpriteComponent::setAnimFPS(float animFPSP) { animFPS = animFPSP; }
