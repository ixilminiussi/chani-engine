...
const Vector3 Vector3::infinity(Maths::infinity, Maths::infinity,
                                Maths::infinity);
const Vector3 Vector3::negInfinity(Maths::negInfinity, Maths::negInfinity,
                                   Maths::negInfinity);
...
float Vector3::length() const { return (Maths::sqrt(lengthSq())); }
