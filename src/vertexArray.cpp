...
VertexArray::VertexArray(const float *verticesP, unsigned int nbVerticesP, const unsigned int *indicesP,
...
unsigned int VertexArray::getNbVertices() const
{
    return nbVertices;
}

unsigned int VertexArray::getNbIndices() const
{
    return nbIndices;
}
