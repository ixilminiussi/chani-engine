...
void SpriteComponent::setMaterial(Material *materialP) { material = materialP; }
...
int SpriteComponent::getDrawOrder() const { return drawOrder; }

int SpriteComponent::getTexWidth() const { return texWidth; }

int SpriteComponent::getTexHeight() const { return texHeight; }

bool SpriteComponent::getVisible() const { return isVisible; }
