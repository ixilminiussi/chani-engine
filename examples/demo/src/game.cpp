...
void Game::load()
{
    ...
    Assets::loadPhongMaterial("assets/materials/CatWarrior.mat", "Mat_CatWarrior");
    Assets::loadPhongMaterial("assets/materials/Cube.mat", "Mat_Cube");
    Assets::loadPhongMaterial("assets/materials/Plane.mat", "Mat_Plane");
    Assets::loadPhongMaterial("assets/materials/RacingCar.mat", "Mat_RacingCar");
    ...
    Assets::loadSpriteMaterial("assets/materials/Crosshair.mat", "Mat_Crosshair");
    ...
    renderer.setClearColor(Vector3(128.0f / 255.f, 218.0f / 255.0f, 235.0f / 255.0f));
